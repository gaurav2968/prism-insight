...
# WiseReport URL configuration archived — see _archive/prism-kr/cores/utils.py
...
def clean_markdown(text: str) -> str:
    ...
    # Remove tool call JSON patterns (e.g., {"name":"yahoo_finance-get_stock_info","arguments":{...}})
    ...
    # Pattern matches Hangul syllables (range: \uAC00-\uD7A3)
